...
import { loadHeightMap } from "./hmapLoader.js";
...
function updateMovement() {
  ...
  const forward = [
    ...
    if (camera.transform.translation[0] > 1000) {
        camera.transform.translation[0] = 0;
        currentChunkX += 1;
    } else if (camera.transform.translation[0] < 0) {
        camera.transform.translation[0] = 1000;
        currentChunkX -= 1;
    }
    if (camera.transform.translation[2] > 1000) {
        camera.transform.translation[2] = 0;
        currentChunkZ += 1;
    } else if (camera.transform.translation[2] < 0) {
        camera.transform.translation[2] = 1000;
        currentChunkZ -= 1;
    }
